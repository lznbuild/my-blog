...
//可以这样理解，Child.prototype成为Parent的实例，实例自然可以访问父级原型上的属性和方法，Child.prototype.__proto__ === Parent.prototype // true
...
借用构造函数的继承方式，可以给父父构造函数传递参数了
原型链继承，请不要在继承完毕后重写子构造函数的原型对象，会切断继承关系